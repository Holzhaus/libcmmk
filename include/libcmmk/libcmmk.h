...
enum cmmk_effect_id {
	...
	CMMK_EFFECT_CYCLE,
	CMMK_EFFECT_SINGLE,
	CMMK_EFFECT_SINGLERAND,
	CMMK_EFFECT_WAVE,
	CMMK_EFFECT_RIPPLE,
	CMMK_EFFECT_RIPPLE2,
	CMMK_EFFECT_CROSS,
	CMMK_EFFECT_RAINDROPS,
	CMMK_EFFECT_STARS,
	CMMK_EFFECT_SNAKE,
	CMMK_EFFECT_CUSTOMIZED,
	CMMK_EFFECT_MULTILAYER,
	CMMK_EFFECT_OFF,
	CMMK_EFFECT_LASER,
	CMMK_EFFECT_COLORCYCLE,
	CMMK_EFFECT_SWIRLPASSIVE,
	CMMK_EFFECT_SWIRLACTIVE,
};

const int16_t cmmk_effect_id_map_a[] = {
	[CMMK_EFFECT_FULLY_LIT] = 0x00,
	[CMMK_EFFECT_BREATHE] = 0x01,
	[CMMK_EFFECT_CYCLE] = 0x02,
	[CMMK_EFFECT_SINGLE] = 0x03,
	[CMMK_EFFECT_SINGLERAND] = -1,
	[CMMK_EFFECT_WAVE] = 0x04,
	[CMMK_EFFECT_RIPPLE] = 0x05,
	[CMMK_EFFECT_RIPPLE2] = -1,
	...
	[CMMK_EFFECT_LASER] = -1,
	[CMMK_EFFECT_COLORCYCLE] = -1,
	[CMMK_EFFECT_SWIRLPASSIVE] = -1,
	[CMMK_EFFECT_SWIRLACTIVE] = -1,
};

const int16_t cmmk_effect_id_map_b[] = {
	[CMMK_EFFECT_FULLY_LIT] = 0x00,
	[CMMK_EFFECT_BREATHE] = 0x08,
	[CMMK_EFFECT_CYCLE] = 0x07,
	[CMMK_EFFECT_SINGLE] = 0x03,
	[CMMK_EFFECT_SINGLERAND] = 0x0a,
	[CMMK_EFFECT_WAVE] = 0x0c,
	[CMMK_EFFECT_RIPPLE] = 0x09,
	[CMMK_EFFECT_RIPPLE2] = 0x0f,
	[CMMK_EFFECT_CROSS] = 0x02,
	[CMMK_EFFECT_RAINDROPS] = 0x06,
	[CMMK_EFFECT_STARS] = 0x05,
	[CMMK_EFFECT_SNAKE] = 0x10,
	[CMMK_EFFECT_CUSTOMIZED] = 0x04,
	[CMMK_EFFECT_MULTILAYER] = 0xff,
	[CMMK_EFFECT_OFF] = 0x11,
	[CMMK_EFFECT_LASER] = 0x0b,
	[CMMK_EFFECT_COLORCYCLE] = 0x01,
	[CMMK_EFFECT_SWIRLPASSIVE] = 0x0d,
	[CMMK_EFFECT_SWIRLACTIVE] = 0x0e,
};

const int16_t *cmmk_effect_id_map[] = {
	[CMMK_PROTOCOL_TYPE_A] = cmmk_effect_id_map_a,
	[CMMK_PROTOCOL_TYPE_B] = cmmk_effect_id_map_b,
};
